...
def show():
>>>>>>> 01b3fe5e256a278fe3ae962489d575db526301b9
    ...
    with col1:
        uploaded_file = st.file_uploader("Upload an image of you today", type=["png", "jpg", "jpeg"])
    ...
    if st.session_state.show_outfits :
        ...
        with st.form("choice_form"):
            outfit_choice = st.radio("Select an outfit", options=["Outfit 1", "Outfit 2", "Outfit 3"])
            ...
            if submitted_choice:
                ...
                with st.spinner("Switching clothes on your picture... ⏳"):
                    time.sleep(3)  
                    img.image("https://via.placeholder.com/200", caption="Your new outfit", width=200)
